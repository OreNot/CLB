...
<div class="form-row">
    ...
    <form method="post" enctype="multipart/form-data" id="js-upload-form">
        <h4 class="display-4">Добавление Банка</h4>
        <div class="jumbotron">
        ...
        <div class="form-group row mt-3">
            <div class="col-sm-9">
                <#if bankname??>
                    <input type="text" class="form-control" name="bankname" placeholder="Наименование" value="${bankname}"/>
                <#else>
...
-->
        <div class="form-group row mt-3">
            <div class="col-sm-3">
            <button type="submit" class="btn btn-primary mb-2">Добавить банк</button>
            </div>
        </div>

        <div class="form-group row mt-3">
            <div class="col-sm-3">
                <button class="btn btn-secondary mb-2" onclick="window.open('${urlprefixPath}/showbanks');window.close(this)">Выйти без изменения</button>
            </div>
        </div>
