    ...
    <div class="form-row">
        <div class="form-group col-md-10">
            <form method="post" enctype="multipart/form-data" id="js-upload-form">
                ...
                <div><h3 class="display-4">Антивирус <#if antivirus?has_content>${antivirus.avName} Весрия: ${antivirus.avVersion}</#if></h3></div>


                <table class="table">
                    <thead>
                    <tr>
                        <th scope="col"><button class="btn btn-primary mb-2" onclick="window.close(this);window.open('${urlprefixPath}/adddocument?id=${antivirus.id}&type=antivirus')">Добавить документ</button></th>
                    ...
                    <table class="table">
                        ...
                        <#list documents as document>
                            ...
                            <tr class="table-light"
                                ...
                                <td><input type="button" class="btn btn-danger" value="Удалить" onclick="window.close(this);window.open('${urlprefixPath}/deleteelement?id=${document.id}&type=document&returntype=antivirus&returnid=${antivirus.id}')"></td>
